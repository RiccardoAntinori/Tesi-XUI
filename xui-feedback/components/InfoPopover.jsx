      ...
      {open && (
        <div className="absolute right-0 top-10 z-50 w-[min(28rem,90vw)] rounded-md border border-black/10 dark:border-white/20 bg-white dark:bg-black shadow-lg p-3 text-sm leading-relaxed">
          ...
          <ul className="list-disc pl-5 space-y-1 opacity-90">
            <li>Completed items are auto‑archived after ~3 seconds.</li>
            <li>Adding a near‑duplicate updates the existing task name; if completed, it becomes active.</li>
            <li>"Completed" view lets you restore or permanently delete completed items.</li>
          </ul>
        </div>
      )}
    </div>
